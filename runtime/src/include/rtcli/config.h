...
// If you want to choose GC implementation, define this macro.
//#define RTCLI_NO_GC
//#define RTCLI_BOEHM_GC

#if defined(RTCLI_NO_GC) || defined(RTCLI_BOEHM_GC)
#else
#define RTCLI_NO_GC
#endif
...
#ifdef __cplusplus
#define RTCLI_EXTERN_C extern "C"
#define RTCLI_NULL nullptr
#else
#define RTCLI_EXTERN_C
#define RTCLI_NULL 0
#endif 
